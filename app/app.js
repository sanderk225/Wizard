...
function appHeader(title, options = {}) {
  ...
  return `
    <header class="topbar">
      ${backAction ? `<button class="icon-button" data-action="${backAction}" aria-label="Go back">←</button>` : '<img class="brand-mark" src="./icon.svg" alt="" />'}
  ...
  return `
    <main class="home-view">
      <section class="home-hero">
        <img src="./icon.svg" class="hero-mark" alt="" />
